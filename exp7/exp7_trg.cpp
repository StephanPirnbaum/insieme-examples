...
irt_lock global_omp_critical_lock_reduce_2;

/* ------- Function Definitions --------- */
int32_t IMP_main() {
    irt_lock_init(&global_omp_critical_lock_reduce_2);
    int32_t var_0 = 4;
    {
        irt_merge(irt_parallel(&INS_INIT(irt_parallel_job){1ul, 4294967295ul, 1ul, &g_insieme_impl_table[0], (irt_lw_data_item*)(&INS_INIT(__insieme_type_15){3, &var_0})}));
    };
    return 0;
}
/* ------- Function Definitions --------- */
void insieme_wi_1_var_0_impl(irt_work_item* var_0) {
    *(*(__insieme_type_15*)(*var_0).parameters).c1 = IMP_main();
}
// --- the meta info table --- 
...
void _ins_omp_parallel_1(int32_t* var_0) {
    int32_t var_1 = 0;
    {
        for (int32_t var_2 = 0; var_2 < 100; ++var_2) {
            var_1+=var_2;
        };
    };
    {
        irt_lock_acquire(&global_omp_critical_lock_reduce_2);
        {
            *var_0 = *var_0 + var_1;
        };
        irt_lock_release(&global_omp_critical_lock_reduce_2);
    };
    irt_wi_join_all(irt_wi_get_current());
}
/* ------- Function Definitions --------- */
void insieme_wi_0_var_0_impl(irt_work_item* var_0) {
    _ins_omp_parallel_1((*(__insieme_type_15*)(*var_0).parameters).c1);
}
// --- work item variants ---
...
size_t g_type_3_components_offset[] = {offsetof(__insieme_type_15, c0), offsetof(__insieme_type_15, c1), };
size_t g_type_6_components_offset[] = {offsetof(__insieme_type_17, c0), offsetof(__insieme_type_17, c1), offsetof(__insieme_type_17, c2), offsetof(__insieme_type_17, c3), };
...
irt_type g_insieme_type_table[] = {
    ...
    {IRT_T_STRUCT, sizeof(__insieme_type_15), 2, g_type_3_components, g_type_3_components_offset},
    {IRT_T_POINTER, sizeof(char*), 0, 0, 0},
    {IRT_T_POINTER, sizeof(char**), 1, g_type_5_components, 0},
    {IRT_T_STRUCT, sizeof(__insieme_type_17), 4, g_type_6_components, g_type_6_components_offset}
};
...
int32_t main(int32_t var_0, char** var_1) {
    int32_t var_2 = 0;
    irt_runtime_standalone(irt_get_default_worker_count(), &insieme_init_context, &insieme_cleanup_context, &g_insieme_impl_table[1], (irt_lw_data_item*)(&INS_INIT(__insieme_type_17){6, var_0, var_1, &var_2}));
    return var_2;
}
