...
int32_t IMP_main() {
    {
        irt_merge(irt_parallel(&INS_INIT(irt_parallel_job){1ul, 4294967295ul, 1ul, &g_insieme_impl_table[2], (irt_lw_data_item*)(&INS_INIT(__insieme_type_17){1})}));
    };
    return 0;
}
...
/* ------- Function Definitions --------- */
void insieme_wi_3_var_0_impl(irt_work_item* var_0) {
    *(*(__insieme_type_22*)(*var_0).parameters).c1 = IMP_main();
}
...
void insieme_wi_0_var_0_impl(irt_work_item* var_0) {
    irt_work_item_range var_1 = (*var_0).range;
    int32_t var_2 = var_1.begin;
    int32_t var_3 = var_1.end;
    int32_t var_4 = var_1.step;
    {
        int32_t var_5 = var_2;
        int32_t var_6 = var_3;
        int32_t var_7 = var_4;
        for (int32_t var_8 = var_5; var_8 < var_6; var_8+=var_7) {
            printf("First Loop, Thread: #(%d), Iteration: #(%d)", (int32_t)irt_wi_get_wg_num(irt_wi_get_current(), 0u), var_8);
        };
    };
}
...
void _ins_omp_parallel_1() {
    {
        ...
        irt_wg_barrier(irt_wi_get_wg(irt_wi_get_current(), 0u));
        {
            {
                {
                    irt_pfor(irt_wi_get_current(), irt_wi_get_wg(irt_wi_get_current(), 0u), INS_INIT(irt_work_item_range){0, (int32_t)irt_wi_get_wg_num(irt_wi_get_current(), 0u), 1}, &g_insieme_impl_table[0], (irt_lw_data_item*)(&INS_INIT(__insieme_type_17){1}));
                    irt_wg_barrier(irt_wi_get_wg(irt_wi_get_current(), 0u));
                };
            };
        };
        {
            {
                {
                    irt_pfor(irt_wi_get_current(), irt_wi_get_wg(irt_wi_get_current(), 0u), INS_INIT(irt_work_item_range){0, (int32_t)irt_wi_get_wg_num(irt_wi_get_current(), 0u), 1}, &g_insieme_impl_table[1], (irt_lw_data_item*)(&INS_INIT(__insieme_type_17){1}));
                };
            };
        };
        printf("Done, Thread: #(%d)", (int32_t)irt_wi_get_wg_num(irt_wi_get_current(), 0u));
    };
...
void insieme_wi_1_var_0_impl(irt_work_item* var_0) {
    ...
    int32_t var_4 = var_1.step;
    {
        ...
        int32_t var_7 = var_4;
        for (int32_t var_8 = var_5; var_8 < var_6; var_8+=var_7) {
            printf("Second Loop, Thread: #(%d), Iteration: #(%d)", (int32_t)irt_wi_get_wg_num(irt_wi_get_current(), 0u), var_8);
        };
    };
}
// --- work item variants ---
...
size_t g_type_1_components_offset[] = {offsetof(__insieme_type_17, c0), };
size_t g_type_6_components_offset[] = {offsetof(__insieme_type_24, c0), offsetof(__insieme_type_24, c1), offsetof(__insieme_type_24, c2), offsetof(__insieme_type_24, c3), };

// --- the type table ---
irt_type g_insieme_type_table[] = {
    {IRT_T_UINT32, sizeof(irt_type_id), 0, 0, 0},
    {IRT_T_STRUCT, sizeof(__insieme_type_17), 1, g_type_1_components, g_type_1_components_offset},
    ...
    {IRT_T_STRUCT, sizeof(__insieme_type_24), 4, g_type_6_components, g_type_6_components_offset}
};
...
int32_t main(int32_t var_0, char** var_1) {
    int32_t var_2 = 0;
    irt_runtime_standalone(irt_get_default_worker_count(), &insieme_init_context, &insieme_cleanup_context, &g_insieme_impl_table[3], (irt_lw_data_item*)(&INS_INIT(__insieme_type_24){6, var_0, var_1, &var_2}));
    return var_2;
}
